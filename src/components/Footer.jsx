            ...
            <li>
              ...
              >
                ...
                <svg
                  ...
                  aria-hidden="true"
                >
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.784 1.764-1.75 1.764zm13.5 11.268h-3v-5.604c0-1.337-.025-3.059-1.863-3.059-1.863 0-2.148 1.454-2.148 2.959v5.704h-3v-10h2.881v1.367h.041c.401-.76 1.379-1.563 2.841-1.563 3.039 0 3.6 2.001 3.6 4.604v5.592z" />
                </svg>
              </a>
            </li>
